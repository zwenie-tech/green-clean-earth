    ...
    return (
        <div>
              ...
              <div className="flex">
                ...
                <div className="w-2 bg-primary rounded-l-lg"></div>
                    ...
                    <div className="ml-10 mb-10 mt-7 p-5">
                        ...
                        <p className="mt-2">
                        ഗ്രീൻ ക്ളീൻ കേരള  -സുസ്‌ഥിര വികസന   പദ്ധതികളുടെ   ഭാഗമായി 2024  ജൂൺ  5  മുതൽ  2025 ജൂൺ  5 വരെ ഹരിത  മത്സരങ്ങൾ  സംഘടിപ്പിക്കുന്നു.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="ml-9 mr-7 mt-9 shadow-lg">
              <div className="flex">
                {/* gay bar */}
                <div className="w-5 bg-primary rounded-l-lg"></div>
                    {/* Larger part with heading and paragraph */}
                    <div className="ml-10 mb-10 mt-7 p-5">
            ...
            <div className="ml-9 mr-7 mt-9 shadow-lg">
              <div className="flex">
                {/* gay bar */}
                <div className="w-4 bg-primary rounded-l-lg"></div>
                    {/* Larger part with heading and paragraph */}
                    <div className="ml-10 mb-10 mt-7 p-5">
                        <h2 className="text-xl font-bold">വൃക്ഷത്തൈ പരിപാലന മത്സരം</h2>
                        <p className="mt-2">
                        നിങ്ങൾ  ഈ വർഷം  നട്ട  വൃക്ഷത്തൈകൾ  ഇപ്പോൾ  പരിപാലിച്ച്  അതിന്റെ  കൂടെ  ഒരു  സെൽഫി  എടുത്ത്  ഈ വെബ്‌സൈറ്റിൽ  അപ്‌ലോഡ്  ചെയ്യുക . അപ്പോൾ  നിങ്ങൾക്ക്  ഒരു  TREE  NUMBER  ലഭിക്കുന്നതാണ് . (ഇത്  ഓർത്ത്  വെക്കുക .മറ്റു മത്സരങ്ങളിൽ  പങ്കെടുക്കുവാൻ  ഇത് ആവശ്യമാണ് .)
                        <br/>
                        <br/>
                        മൂന്ന്  മാസം  കഴിഞ്ഞാൽ  അതിൻറെ കൂടെ  വീണ്ടും  സെൽഫി  എടുത്ത്  ഈ വെബ്‌സൈറ്റിൽ  അപ്‌ലോഡ്  ചെയ്യുക .അങ്ങിനെ  വർഷത്തിൽ  നാല്  പ്രാവശ്യം   ആവർത്തിക്കുക. ഇങ്ങനെ  സ്ഥാപനത്തിലെ  മുഴുവൻ  വിദ്യാത്ഥികളും  അദ്ധ്യാപകരും അപ്‌ലോഡ്  ചെയ്യുക .
                        <br/>
                        <br/>
              ...
              <div className="flex">
                ...
                <div className="w-2 bg-primary rounded-l-lg"></div>
                    ...
                    <div className="ml-10 mb-10 mt-7 p-5">
                        ...
                        <br/>
                        <br/>
                        കലാ  മത്സരങ്ങളിൽ  പങ്കെടുക്കക്കുന്നവരെല്ലാം  തന്നെ  വൃക്ഷത്തൈ  പരിപാലന  മത്സരത്തിൽ  പങ്കെടുത്തതിന്റെ  TREE NUMBER -ഓ   ഏതെങ്കിലും  ഒരു  ഗ്രീൻ ആക്ടി നടത്തിയതിന്റെ  CHEST  NUMBER  ഓ  ഈ വെബ്‌സൈറ്റിൽ  എന്റർ ചെയ്യേണ്ടതാണ് .
                        </p>
                    </div>
                </div>
            </div>
              ...
              <div className="flex">
                ...
                <div className="w-4 bg-primary rounded-l-lg"></div>
                    ...
                    <div className="ml-10 mb-10 mt-7 p-5">
                        ...
                        <p className="mt-2">
                        വൃക്ഷത്തൈ  പരിപാലന  മത്സരത്തിൽ  പങ്കെടുക്കുകയും ,    മേൽ പറഞ്ഞ  വിഷയങ്ങളിൽ നിങ്ങൾ ചെയ്ത്  കഴിഞ്ഞതോ , ചെയ്ത്  കൊണ്ടിരിക്കുന്നതോ , ചെയ്യാൻ  പോകുന്നതോ , മറ്റുള്ളവർക്ക്  ചെയ്യാൻ കഴിയുന്നതോ  ആയ   പ്രായോഗികമായ  പദ്ധതികളോ     നിങ്ങളുടെ  സർഗ്ഗ കലാ ശിൽപ കായിക വിസ്മയ പ്രകടനങ്ങളോ   ആണ് സമർപ്പിക്കേണ്ടത്.
                        <br/>
                        <br/>
                        മികച്ച  വിദ്യാലയം , മികച്ച  വിദ്യാർത്ഥി ,  മികച്ച  കോർഡിനേറ്റർ , മികച്ച പ്രൊമോട്ടർ, മികച്ച ഉപജില്ല , മികച്ച മികച്ച വിദ്യാഭ്യാസ  ജില്ല , മികച്ച  ജില്ല , മികച്ച ഇതര  സംസ്ഥാന  മലയാളി  കൂട്ടായ്‌മ , മികച്ച ഇതര  സംസ്ഥാനം , മികച്ച ഇതര  രാജ്യ   മലയാളി  കൂട്ടായ്‌മ  മികച്ച ഇതര  രാജ്യം പ്രൊഫസ്സർ  മുതലായവയ്ക്ക്  ശോഭീന്ദ്രന്റെ  പേരിൽ  പുരസ്കാരങ്ങളും  സമ്മാനങ്ങളും സർട്ടിഫിക്കറ്റുകളും നൽകുന്നതുമാണ്.
                        </p>
                    </div>
                </div>
            </div>
              ...
              <div className="flex">
                ...
                <div className="w-5 bg-primary rounded-l-lg"></div>
                    ...
                    <div className="ml-10 mb-10 mt-7 p-5">
                        ...
                        <br/>
                        <br/>
                        അതിന്  ശേഷം കോർഡിനേറ്റർ  വെബ്‌സൈറ്റിൽ  നിന്നും  ലഭിക്കുന്ന  ഒരു  ലിങ്ക്  സ്ഥാപനത്തിലെ  മുഴുവൻ  വിദ്യാർത്ഥികൾക്കും  അദ്ധ്യാപകർക്കും    അയച്ച്  കൊടുക്കേണ്ടതാണ് . മത്സരത്തിൽ  പങ്കെടുക്കുന്നവരെല്ലാം ഈ ലിങ്ക്   ക്ലിക്ക്  ചെയ്ത് സ്വന്തം  ഫോൺ  നമ്പർ ഉപയോഗിച്ച്   ഒരു  പാസ്സ്‌വേർഡ്  ക്രിയേറ്റ്  ചെയ്ത് USER  ആയി രജിസ്റ്റർ ചെയ്യേണ്ടതാണ് . തുടർന്ന്  LOGIN  ചെയ്ത്  മത്സരത്തിൽ  പങ്കെടുക്കാവുന്നതാണ് .
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="ml-9 mr-7 mt-9 shadow-lg">
              <div className="flex">
                {/* gay bar */}
                <div className="w-3 bg-primary rounded-l-lg"></div>
                    {/* Larger part with heading and paragraph */}
                    <div className="ml-10 mb-10 mt-7 p-5">
                        <h2 className="text-xl font-bold">മത്സരത്തിൽ  കൂടുതൽ  പോയിന്റ് ലഭിക്കാൻ  നിങ്ങൾ  ചെയ്യേണ്ടത് </h2>
                        <p className="mt-2">
                        1) സ്ഥാപനത്തിലെ  മുഴുവൻ  മെമ്പർമാരെയും  മത്സരത്തിൽ  പങ്കെടുപ്പിക്കുക
                        <br/>
                        <br/>
                        2) നിങളുടെ  സുഹൃത്തുക്കളായ   കേരളത്തിലെ  മറ്റുപ്രദേശങ്ങളിലുള്ള  വിദ്യാലയങ്ങളെയും , സന്നദ്ധ സംഘടനകളെയും , വാർഡുകളെയും , റെസിഡൻസ്  അസ്സോസിയേഷനുകളെയും  ഈ മത്സരത്തിൽ  പങ്കെടുപ്പിക്കുക .
                        <br/>
                        <br/>
                        3)സ്വന്തം  വിദ്യാലയത്തിലെ  ഹരിത  പ്രവർത്തനങ്ങൾക്ക്കൊപ്പം  നിങ്ങൾ  പ്രൊമോട്ട്  ചെയ്ത മറ്റുസ്ഥാപനങ്ങളിലെ  ഹരിത  പ്രവർത്തനങ്ങളും  മികച്ച  പ്രൊമോട്ടർമാരായ  കോർഡിനേറ്റർ മാരെ  തിരഞ്ഞെടുക്കുന്നതയിൽ  പരിഗണിക്കുന്നതാണ് .
                        </p>
                    </div>
                </div>
            </div>
