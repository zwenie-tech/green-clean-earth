...
export function DialogUploadPlant({token}:any) {
  ...
  return (
    <Dialog >
      ...
      <div 
        className="flex flex-col justify-start items-start gap-3 text-xl border-2 border-dashed border-primary rounded-3xl py-6 md:py-10 bg-white hover:bg-primary/10 cursor-pointer transition-all hover:scale-105">
