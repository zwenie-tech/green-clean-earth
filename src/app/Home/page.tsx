    ...
    <div className="body">
      ...
      <div className="container mx-auto p-0">
        <div className="grid gap-0 md:grid-cols-3 sm:grid-cols-1">   
          {/* Box 1 */}
          <div className=" bg-light-gray flex flex-col justify-center items-center px-4 py-8">
          ...
          {/* Box 3 */}
          <div className=" bg-light-gray relative flex justify-center items-center bg-cover ">
     ...
     {/* container 1 */}
       <div className={`p-4  m-4 shadow-md ${isOpen5 ? 'bg-light-green' : 'bg-light-gray'}`} >
...
ഒരു ലക്ഷം രൂപയുടെ പുരസ്കാരങ്ങളും സമ്മാനങ്ങളും</h2>
    ...
    {/* container 4 */}
    <div className={`p-4  m-4 shadow-md ${isOpen4 ? 'bg-light-green' : 'bg-light-gray'}`} >
      <div className="flex justify-between items-center">
    ...
    {/* container 6 */}
    <div className={`p-4  m-4 shadow-md ${isOpen6 ? 'bg-light-green' : 'bg-light-gray'}`} >
      <div className="flex justify-between items-center">
    ...
    {/* container 7 */}
    <div className={`p-4  m-4 shadow-md ${isOpen7 ? 'bg-light-green' : 'bg-light-gray'}`} >
      <div className="flex justify-between items-center">
