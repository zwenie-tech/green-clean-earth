...
const aboutus =()=>{
    const directors = [
        ...
        { title: "Director & Marketting coordinator", name: "Anvar Sadik", location: "Palazhi" },
        ...
        { title: "Director & Event coordinator", name: "Naser.Pattani", location: "Koduvaly" },
        { title: "Director & Event coordinator", name: "V.P Asraf", location: "Koduvaly" },
        ...
        <>
            ...
            <div className="flex justify-center items-center mt-10">
               ...
               {directors.map((director, index) => (
                <div className="mt-8 bg-light-gray p-5 text-center rounded-lg  mx-11 md:mx-40">
                 <div key={index} className="bg-light-gray p-10 text-center rounded-lg mx-10 md:mx-40">
