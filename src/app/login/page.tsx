            ...
            <div className="bg-white p-6">
              ...
              <div className="mt-2">
                <p className="text-sm text-gray-500">
                  ഈ വെബ്സൈറ്റിലെ രജിസ്ട്രേഷൻ പുതിയ രീതിയിൽ ഡിസൈൻ ചെയ്തിരിക്കുന്നു.
                  നേരത്തെ രജിസ്റ്റർ ചെയ്ത മുഴുവൻ  വ്യക്തികളും  പുതിയ രീതിയിൽ രജിസ്റ്റർ ചെയ്യേണ്ടതാണ്.
                  ആദ്യം സ്ഥാപനത്തിലെ പരിസ്ഥിതി കോഡിനേറ്റർ, സ്ഥാപനത്തിന്റെ പേര് രജിസ്റ്റർ ചെയ്തതിനുശേഷം, അവർ അയച്ചുതരുന്ന ലിങ്ക് പ്രകാരമാണ്, മറ്റുള്ളവർ  രജിസ്റ്റർ ചെയ്യേണ്ടത്.
                  സംശയങ്ങൾക്ക് നിങ്ങളുടെ സ്ഥാപനത്തിലെ
                  കോഡിനേറ്ററുമായി ബന്ധപ്പെടുക.
                  കോഡിനേറ്റർമാർ താഴെ കൊടുത്ത  നമ്പറിൽ ബന്ധപ്പെടുക
                  9645964592
                </p>
              </div>
              <div className="mt-4">
