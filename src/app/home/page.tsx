...
//7s
  ...
  return (
    ...
    <div className="max-w-4xl mx-auto my-2">
        {/* container 1 */}
        <div onClick={toggleOpen1} className={`p-4 my-4 mt-6 mx-auto shadow-md rounded-lg ${isOpen1 ? 'bg-light-green' : 'bg-light-gray'}`} >
        ...
        {isOpen1 && (
          <>
            ...
            {/* container 2 */}
            <div onClick={toggleOpen2} className={`p-4 my-4 mx-auto shadow-md rounded-lg ${isOpen2 ? 'bg-light-green' : 'bg-light-gray'}`} >
        <div className="flex justify-between items-center">
        ...
        {isOpen2 && (
          <>
            ...
            {/* container 3 */}
            <div onClick={toggleOpen3} className={`p-4 my-4 mx-auto shadow-md rounded-lg ${isOpen3 ? 'bg-light-green' : 'bg-light-gray'}`} >
        <div className="flex justify-between items-center">
        ...
        {isOpen3 && (
          <>
            ...
            {/* container 4 */}
            <div onClick={toggleOpen4} className={`p-4  my-4 mx-auto  shadow-md rounded-lg ${isOpen4 ? 'bg-light-green' : 'bg-light-gray'}`} >
        <div className="flex justify-between items-center">
        ...
        {isOpen4 && (
          <>
            ...
            {/* container 5 */}
            <div onClick={toggleOpen5} className={`p-4  my-4 mx-auto  shadow-md rounded-lg ${isOpen5 ? 'bg-light-green' : 'bg-light-gray'}`} >
        <div className="flex justify-between items-center">
        ...
        {isOpen5 && (
          <>
            ...
            {/* container 6 */}
            <div onClick={toggleOpen6} className={`p-4  my-4 mx-auto  shadow-md rounded-lg ${isOpen6 ? 'bg-light-green' : 'bg-light-gray'}`} >
        <div className="flex justify-between items-center">
        ...
        {isOpen6 && (
          <>
            ...
            {/* container 7 */}
            <div onClick={toggleOpen7} className={`p-4  my-4 mx-auto  shadow-md rounded-lg ${isOpen7 ? 'bg-light-green' : 'bg-light-gray'}`} >
        <div className="flex justify-between items-center">
