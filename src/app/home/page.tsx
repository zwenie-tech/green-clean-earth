    ...
    <div className="body">
      ...
      <div className="container mx-auto p-0">
        <div className="grid gap-0 md:grid-cols-3 sm:grid-cols-1">   
          {/* Box 1 */}
          <div className="flex flex-col justify-center items-center px-4 py-8"style={{backgroundColor:'#d3d3d3'}}>
            ...
            <Link href="/project" legacyBehavior>
              <a className="mt-2 self-start px-2" style={{ textDecoration: 'none' ,fontWeight:'bold'}}>Read more</a>
            </Link>
          </div>  
          {/* Box 2 */}
          {dynamicContent}
          ...
          {/* Box 3 */}
          <div className="relative flex justify-center items-center bg-cover bg-center  p-4" style={{ backgroundColor:'#d3d3d3' }}>
     ...
     {/* container 1 */}
       <div className={`p-4  m-4 shadow-md ${isOpen5 ? 'bg-[#D9E4C1]' : 'bg-gray-300'}`} >
...
ഒരു ലക്ഷം രൂപയുടെ പുരസ്കാരങ്ങളും സമ്മാനങ്ങളും</h2>
    ...
    {/* container 4 */}
    <div className={`p-4  m-4 shadow-md ${isOpen4 ? 'bg-[#D9E4C1]' : 'bg-gray-300'}`} >
      <div className="flex justify-between items-center">
    ...
    {/* container 6 */}
    <div className={`p-4  m-4 shadow-md ${isOpen6 ? 'bg-[#D9E4C1]' : 'bg-gray-300'}`} >
      <div className="flex justify-between items-center">
    ...
    {/* container 7 */}
    <div className={`p-4  m-4 shadow-md ${isOpen7 ? 'bg-[#D9E4C1]' : 'bg-gray-300'}`} >
      <div className="flex justify-between items-center">
...
Supported by indian Oil Corporation and myG, VKC,tecQ, Aqua garden, Mall of garden, AGRI SUPER MARKET, KISAN EXCEL, a2z4home.
  ...
  <div className="flex justify-between items-center absolute top-0 left-0 right-0 z-10 p-4 h-full">
    <button
  ...
  <div className="flex overflow-hidden w-full">
      ...
      >
        <div
          className={`p-6 shadow-md rounded-md h-full ${
            index % 2 === 0 ? 'bg-gray-300' : 'bg-[#D9E4C1]'
          }`}
        >
   ...
   <div className="flex justify-center mt-2">
    ...
    <div className="d-flex justify-content-center my-4">
          ...
          <p className="mb-4" style={{ textAlign:'center', fontSize: '15px', padding: '14px', gap: '7px', color: 'black', }}>
    ...
    <div className="container mx-auto p-4 ">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4" >
        {cards.map((card, index) => (
          <div key={index} className="p-4  shadow-md" style={{backgroundColor:'#d3d3d3',borderRadius:'9px'}} >
            ...
            <p className="mt-2 text-gray-700">{card.paragraph}</p>
                <button className="self-start" style={{ textDecoration: 'none' ,fontSize: '14px',backgroundColor:'white',padding:'10px',marginTop:'15px',borderRadius:'5px'}}> Read more ...</button>
          </div>
        ))}
      </div>
    </div>
    <div style={{marginLeft:"40%"}}>
              <button className="font-bold py-2 px-4 rounded-full" style={{color:'#3C6E1F',backgroundColor:'#d3d3d3',paddingLeft:'20px',paddingRight:'20px'}}>
                Read More > >
              </button>
            </div>
            <div>
        <h1 style={{ fontSize: '30px', marginLeft: "42%" }}>Videos</h1>
  <div className="container mx-auto p-6">
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div className="flex justify-between" style={{height:'250px',backgroundColor:'#DAD4D2 '}}>
        {/* First Div */}
      </div>
      <div className="flex justify-between " style={{height:'250px',backgroundColor:'#DAD4D2 '}}>
        {/* Second Div */}
