        ...
        <div className="max-w-screen-xl mx-auto p-4 mb-6">
          <Accordion type="single" collapsible className='flex flex-col gap-6'>
            <AccordionItem value="item-1" className='bg-light-gray px-4 rounded-xl'>
              ...
              <AccordionContent>
                <ol className='px-4 list-decimal'>
                  ...
                  ലഭിക്കാൻ +91 9645 9645 92  എന്ന  നമ്പറിൽ  WHATASPP  ചെയ്യുക .</li>
                </ol>
                <div className="mt-4">
                  <a 
            ...
            <AccordionItem value="item-4" className='bg-light-gray px-4 rounded-xl'>
              ...
              <AccordionContent>
              <p>
              മത്സരാർത്ഥികൾ പ്രകടനത്തിന്റെ  വീഡിയോ തയ്യാറാക്കിയതിന്   ശേഷം,    സ്‌കൂൾ  കോർഡിനേറ്റർ ആയ  അദ്ധ്യാപകനെ  സമീപിച്ച് IGAR Number (Institution Green Art fest Registration Number)   വാങ്ങിയതിന്  ശേഷം   +91 9645 9645 92  എന്ന നമ്പറിലേക്ക് Whatsapp / Telegram വഴി send ചെയ്യേണ്ടതാണ് .
              <br/>
              <br/>
