...
export function DialogAddUser() {
  ...
  const message = `
  കോഡിനേറ്റർമാർ  ക്ലാസ് അധ്യാപകർക്ക്  അയക്കുന്ന ലിങ്കിന്റെ കൂടെ ഉണ്ടാവേണ്ട മെസ്സേജ്
🥦
പ്രിയപ്പെട്ടവരേ 
        ...
        <DialogHeader>
          ...
          <div>
            <p className="text-base">
              കോഡിനേറ്റർമാർ  ക്ലാസ് അധ്യാപകർക്ക്  അയക്കുന്ന ലിങ്കിന്റെ കൂടെ
              ഉണ്ടാവേണ്ട മെസ്സേജ് 🥦 പ്രിയപ്പെട്ടവരേ
              <br />
              <br />
