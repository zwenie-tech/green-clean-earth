...
const GroupList = () => {
  ...
  const [twoupload, setTwoUpload] = useState("");
  const [threeupload, setThreeUpload] = useState("");
  const [fourupload, setFourUpload] = useState("");
  ...
  async function sort(dir: string, field: string) {
    ...
    field === "activity_count" ? setOrderDir3(dir) : "";
  }
  ...
  const onSubmit = async (data: any) => {
    ...
    if (selectedCountry === "India") {
      ...
      if (selectedState === "Kerala") {
        ...
        setWardNo(data.wardNo ? data.wardNo : "");
      }
    }
    ...
    setTwoUpload(data.twoupload === true ? data.twoupload : "");
    setThreeUpload(data.threeupload === true ? data.threeupload : "");
    setFourUpload(data.fourupload === true ? data.fourupload : "");
