...
const NavigationBar = () => {
  ...
  return (
    <header className="bg-white py-5 shadow-md mb-2 border-b-2">
      <div className="w-full max-w-7xl mx-auto px-5 text-center justify-between items-center">
        <h1 className="text-5xl font-bold text-[#3C6E1F] font-sans mb-5">
        ...
        <ul className="hidden md:flex">
          {links.map((link) => (
            <li key={link.href} className="m-0 mx-2.5">
              <Link href={link.href} passHref>
                <p
                  className={`text-gray-800 no-underline p-1.5 rounded-full transition-colors duration-300 ${
                    pathname === link.href
